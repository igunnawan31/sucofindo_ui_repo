...
const PermintaanBarangRetail = () => {
    ...
    return (
        <>
            ...
            <div className="mt-5">
                <InvoiceShowsPage link="permintaan-barang-retail" showButton={true} buttonText="Accept" onButtonClick={ handleAcceptInvoice } />
            </div>
        </>
    )
}

export default PermintaanBarangRetail